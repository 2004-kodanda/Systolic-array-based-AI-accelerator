1.Developed a Verilog-based hardware accelerator using a systolic array architecture to efficiently perform matrix multiplication, a core operation in neural network inference and training.
